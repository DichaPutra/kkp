                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="col-md-3">
                                        <form method="post" action="<?php echo base_url(); ?>index.php/ADM_Pengumpulan_c">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($dept as $key) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php
                                                        if ($key->bagianpenilai == NULL) {
                                                            echo '<b style="color: red;">Belum Mengisi</b>';
                                                        } else {
                                                    ...
                                                    <td >
                                                        <a href="<?php echo base_url(); ?>index.php/ADM_Pengumpulan_c/detilPengumpulan/<?php echo $key->bagian; ?>/<?php echo $noBulan; ?>/<?php echo $tahun; ?>">
                                                            <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#editAcc">Detil Pengumpulan</button>
                                                        </a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
