                                    ...
                                    <table id="example" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">Jumlah Kuisioner</th>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($account as $key) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url(); ?>index.php/ADM_Kuisioner_c/viewKuisioner/<?php echo $key->bagian; ?>"><button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#editAcc<?php echo $key->username; ?>">Cek Kuisioner</button>
                                                    </td>
