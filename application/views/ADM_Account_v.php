                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <?php echo $pesan; ?>
                                    <h2 class="text-center">List Account</h2><br>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($account as $key) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center" style="color: blue;"><?php echo $key->namapic; ?></td>
                                                    <td>
                                                        <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#editAcc<?php echo $key->username; ?>">Edit Account</button>
                                                    ...
                                                    <!-- Modal Edit -->
                                            <div id="editAcc<?php echo $key->username; ?>" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <form method="POST" action="<?php echo base_url(); ?>index.php/ADM_Account_c/editAccount"> 
                                                            <div class="modal-header">
                                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                                <h4 class="modal-title">Edit Account</h4>
                                                            </div>
                                                            <div class="modal-body">
                                                                <input name="bagianbefore" type="hidden" type="text" value="<?php echo $key->bagian; ?>">
                                                                <input name="usernamebefore" type="hidden" type="text" value="<?php echo $key->username; ?>">
                                                                <label>Nama Bagian :</label>
                                                                <input name="bagian" type="text" maxlength="50" class="form-control" placeholder="Nama Bagian" value="<?php echo $key->bagian; ?>"><br>
                                                                <label>Nama Kepala Departemen :</label>
                                                                <input name="namapic" type="text" maxlength="50" class="form-control" placeholder="Nama Kepala Departemen" value="<?php echo $key->namapic; ?>"><hr>
                                                                <label>Username :</label>
                                                                <input name="username" type="text" maxlength="50" class="form-control" placeholder="Username" value="<?php echo $key->username; ?>">
                                                                <label>Password :</label>
                                                                <input name="pass" type="text" maxlength="50" class="form-control" placeholder="Password" value="<?php echo $key->pass; ?>">
                                    ...
                                    <div id="add" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <form method="POST" action="<?php echo base_url(); ?>index.php/ADM_Account_c/addAccount"> 
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
