                                    ...
                                    <table id="example" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">Jumlah Relasi Penilaian</th>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($account as $key) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center" style="color: blue;"><?php echo $key->jumlahRelasi; ?><?php // echo $key->namapic; ?></td>
                                                    <td>
                                                        <a href="<?php echo base_url(); ?>index.php/ADM_Relasi_c/viewrelasiakun/<?php echo $key->bagian; ?>"><button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#editAcc<?php echo $key->username; ?>">Cek Relasi</button>
                                                    </td>
