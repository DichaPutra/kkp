                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <button type="button" class="btn btn-sm btn-primary pull-right" data-toggle="modal" data-target="#add">Tambah Relasi</button>
                                            ...
                                            foreach ($relasi as $key) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <a href="<?php echo base_url(); ?>index.php/ADM_Relasi_c/deleteRelasi/<?php echo $key->id; ?>/<?php echo "$bagianrelasi"; ?>"><button type="button" class="btn btn-sm btn-danger" onclick="return confirm('Apakah anda yakin akan menghapus relasi KKP tersebut ?');">&#x274c</button></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    ...
                                    <div id="add" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <form method="POST" action="<?php echo base_url(); ?>index.php/ADM_Relasi_c/addRelasi"> 
                                                    <input name="departemen" type="hidden" value="<?php echo "$bagianrelasi"; ?>">
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        <h4 class="modal-title">Tambah Bagian Departemen/Seksi yang dinilai</h4>
                                                    </div>
                                                    <div class="modal-body">

                                                        <div class="form-group">
                                                            <label for="exampleFormControlSelect1">Bagian Departemen/Seksi</label>
                                                            <select name="bagiandinilai"class="form-control" id="exampleFormControlSelect1">
                                                                <?php
//                                                                var_dump($listaccount);
                                                                foreach ($listaccount as $dept) {
                                                                    echo "<option value=\"$dept->bagian\">" . $dept->bagian . "</option>";
                                                                }
                                                                ?>
                                                            </select>
                                                        </div>
