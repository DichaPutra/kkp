                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="col-md-3">
                                        <form method="post" action="<?php echo base_url(); ?>index.php/ADM_KritikSaran_c">
                                    ...
                                    <table id="example" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center" style="width: 50%">Kritik & Saran</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            ...
                                            foreach ($dept as $key) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $key->kritiksaran; ?></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
