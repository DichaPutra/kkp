...
function I(a,b,c){
    ...
    if("ssp"!=y(a)&&0!==h.length){
        ...
        g===h.length?i.sort(function(a,b){
            ...
            for(g=
                0;g<i;g++)if(j=h[g],c=k[j.col],e=m[j.col],c=c<e?-1:c>e?1:0,0!==c)return"asc"===j.dir?c:-c;c=d[a];
            e=d[b];
            return c<e?-1:c>e?1:0
            }):i.sort(function(a,b){
            var c,g,j,i,k=h.length,m=f[a]._aSortData,p=f[b]._aSortData;
            for(j=0;j<k;j++)if(i=h[j],c=m[i.col],g=p[i.col],i=e[i.type+"-"+i.dir]||e["string-"+i.dir],c=i(c,g),0!==c)return c;c=d[a];
            g=d[b];
...
var m=function(a){
    ...
    for(var e in m.ext.internal)e&&(this[e]=Ob(e));this.each(function(){
